            ...
            <div class=" card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="#" class="btn btn-sm btn-primary collapsed" type="button" data-bs-toggle="collapse"
                ...
                <div id="collapseTwo" style="width: 100%;border-width:0px" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                        <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                            <form method="POST" action="{{ route('add-material') }}">
                                @csrf
                                <div class="row">
                            ...
                            <tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST"
                                                        action="{{ route('edit-material', $material) }}">
                                                        @method('PUT')
                                                        @csrf
                                ...
                                <td class="text-center">
                                    ...
                                    <form id="delete-material-{{ $material->id }}" method="post"
                                        action="{{ route('delete-material', $material) }}">@csrf @method('delete')
                                    </form>
                                </td>
                            </tr>
                        @endforeach
