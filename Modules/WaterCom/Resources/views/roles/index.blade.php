            ...
            <div id="collapseTwo" style="width: 100%;border-width:0px" class="accordion-collapse collapse"
                ...
                <div class="accordion-body">
                    <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                        <form method="POST" action="{{ route('watercom.roles.add') }}">
                            @csrf
                            <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form id="toggle-status-form-{{ $role->id }}" method="POST"
                                    action="{{ route('watercom.roles.toggle-status', $role) }}">
                            ...
                            <td>
                                <a href="{{ route('watercom.roles.show', $role) }}" class="btn btn-sm btn-outline-info collapsed"
                                    type="button">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('watercom.roles.edit', $role) }}">
                                                    @method('PUT')
                                                    @csrf
                            ...
                            <td class="text-center">
                                ...
                                <form id="delete-role-{{ $role->id }}" method="post"
                                    action="{{ route('watercom.roles.delete', $role) }}">@csrf @method('delete')
                                </form>
                            </td>
                        </tr>
                    @endforeach
