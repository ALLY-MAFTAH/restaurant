    ...
    <div class="card">
        <div class=" card-header">
            <div class="row">
                <div class="col">
                    <div class=" text-left">
                        <a href="{{ route('watercom.items.index') }}" style="text-decoration: none;font-size:15px">
            ...
            <div id="editCollapse" style="width: 100%;border-width:0px" class="accordion-collapse collapse"
                ...
                <div class="accordion-body">
                    <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                        <form method="POST" action="{{ route('watercom.items.edit', $item) }}">
                            @method('PUT')
                            @csrf
                            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="card"id="edit-form" style="display: none">
                        <div class="card-body">
                            @if ($ingredients->count() == 0)
                                <form method="POST" action="{{ route('watercom.items.add-ingredients', $item) }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col mb-1">
                                            <div
                            ...
                            @else
                                <form id="update-ingredients" method="POST"
                                    action="{{ route('watercom.items.edit-ingredients', $item) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                ...
                                <form id="delete-ingredient-{{ $ingredient->id }}" method="post"
                                    action="{{ route('watercom.items.delete-ingredient', $ingredient) }}">@csrf
                                    @method('delete')
                                </form>
                                <form method="POST" action="{{ route('watercom.items.add-ingredients', $item) }}">
                                    @csrf
    ...
    <div class="card">
        <div class=" card-header">
            <div class="row">
                ...
                <div class="col-sm-7">
                    <form action="{{ route('watercom.items.show',$item) }}" method="GET" id="filter-form">
                        @csrf
