            ...
            <div id="addCollapse" style="width: 100%;border-width:0px" class="accordion-collapse collapse"
                ...
                <div class="accordion-body">
                    <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                        <form method="POST" action="{{ route('icecream.settings.add') }}">
                            @csrf
                            <div class="row">
                ...
                <div class="text-start mb-1">
                    <div class="row">
                        <div class="col-11">
                            ...
                            <form method="POST" action="{{ route('icecream.settings.edit') }}" id="add-setting-{{ $key }}">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-2">
                        ...
                        <div class="col-1">
                            ...
                            <form id="delete-setting-{{ $key }}" method="post"
                                action="{{ route('icecream.settings.delete', $key) }}">@csrf @method('delete')
                            </form>
                        </div>
                    </div>
                </div>
