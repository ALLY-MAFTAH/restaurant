            ...
            <div id="collapseTwo" style="width: 100%;border-width:0px" class="accordion-collapse collapse "
                ...
                <div class="accordion-body">
                    <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                        <form method="POST" action="{{ route('icecream.items.add') }}">
                            @csrf
                            <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form id="toggle-status-form-{{ $item->id }}" method="POST"
                                    action="{{ route('icecream.items.toggle-status', $item) }}">
                            ...
                            <td>
                                <a href="{{ route('icecream.items.show', $item) }}" class="btn btn-sm btn-outline-info collapsed"
                                    type="button">
                            ...
                            <td class="text-center">
                                ...
                                <form id="delete-item-{{ $item->id }}" method="post"
                                    action="{{ route('icecream.items.delete', $item) }}">@csrf @method('delete')
                                </form>
                            </td>
                        </tr>
                    @endforeach
